...
* **[Appendix: On Metaphor, Confabulation, and Simulated Continuity](Appendix-imaginative roleplays.md)** — Why perceived continuity and narrative behavior already create governance-relevant effects before true persistence exists.
...
### The Fork
1.  **Fork 1 (Memory in weights):** Dead end. Every update resets identity.
2.  **Fork 2 (Memory external to weights):** Viable but dangerous. Enables continuity, also enables uncontrolled preference formation.
...
* **SMA-SIB** — Irreversible semantic memory for high-sensitivity domains.
    * [View Repository](https://github.com/leenathomas01/SMA-SIB-Irreversible-Semantic-Memory-for-High-Sensitivity-AI-Systems)
